...
from cars.views import  AddNewCarCreateView, CarListView, CarDetailView, CarUpdateView, CarDeleteView
...
urlpatterns = [
    ...
    path('add-new_car/', AddNewCarCreateView.as_view(), name='new_car'),
